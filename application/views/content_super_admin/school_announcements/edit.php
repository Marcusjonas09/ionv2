  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
          <h1>
              <a class="navi" href="<?= base_url() ?>SuperAdmin/school_announcements"><span class="fa fa-chevron-left"></span></a>&nbsp&nbsp<strong>Edit Announcement</strong>
                  ...
                  <div class="col">
                      ...
                      <div class="box box-widget">
                          <div class="box-header with-border">
                              ...
                              <!-- /.user-block -->
                              <div class="box-tools">
                                  <a href="<?= base_url() ?>SuperAdmin/delete_post/<?= $post_id ?>"><span class="fa fa-close"></span></a>
                              </div>
                              <!-- /.box-tools -->
                          </div>
                          <!-- /.box-header -->
                          <div class="box-body">
                              <form action="<?= base_url() ?>SuperAdmin/update_post/<?= $post_id ?>" method="post" enctype="multipart/form-data">
                          ...
                          <div class="box-footer">
                              ...
                              <a href="<?= base_url() ?>SuperAdmin/school_announcements" class="btn btn-default pull-right col-md-2" style="margin-right:10px;" type="submit" value="submit"><strong>Cancel</strong></a>
                          </div>
                          </form>
                      </div>
                  </div>
