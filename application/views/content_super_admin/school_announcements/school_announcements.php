                      ...
                      <div class="box box-widget">
                          ...
                          <div class="box-body">
                              <div class="user-block">
                                  ...
                                  <div class="col-md-11">
                                      <form action="<?= base_url() ?>SuperAdmin/announce" method="post" enctype="multipart/form-data">
                          ...
                          <div class="box box-widget">
                                  ...
                                  <div class="box-tools">
                                      <div class="btn-group">
                                          ...
                                          <ul class="dropdown-menu">
                                              <li><a href="<?= base_url() ?>SuperAdmin/fetch_post/<?= $post->post_id ?>">View</a></li>
                                              <li><a href="<?= base_url() ?>SuperAdmin/edit_post/<?= $post->post_id ?>">Edit</a></li>
                                              <li><a href="<?= base_url() ?>SuperAdmin/delete_post/<?= $post->post_id ?>">Delete</a></li>
                                          </ul>
                                      </div>
                                  </div>
                                  <!-- /.box-tools -->
                              ...
                              <div class="box-body">
                                  <?php if (!empty($post->post_caption)) : ?>
                                      <pre><?= word_limiter($post->post_caption, 8, '<a href=' . base_url() . 'SuperAdmin/fetch_post/' . $post->post_id . '> see more ...<a>'); ?></pre>
                                  <?php endif; ?>
