                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" type="text" name="specialization_code" id="specialization_code" placeholder="Enter code" />
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input class="form-control" type="text" name="specialization_description" id="specialization_description" placeholder="Enter description" />
                        </div>
                    </div>
