    ...
    <section class="content container-fluid">
        <div class="box box-success">
            ...
            <div class="box-body">
                ...
                <?php endif; ?>
                <div class="container-fluid">
                    <a href="<?= base_url() ?>/SuperAdmin/approve_underload/<?= $underload->ou_id ?>/<?= $student->acc_number ?>" type="submit" class="btn btn-success pull-right col-md-1">Approve</a>
                    <a href="<?= base_url() ?>/SuperAdmin/decline_underload/<?= $underload->ou_id ?>/<?= $student->acc_number ?>" class="btn btn-danger pull-right col-md-1" style="margin-right:10px;">Decline</a>
                </div>
            </div>
            <!-- /.box-body -->
        </div>
