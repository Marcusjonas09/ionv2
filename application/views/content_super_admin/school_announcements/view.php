  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
          <h1>
              <a class="navi" href="<?= base_url() ?>SuperAdmin/school_announcements"><span class="fa fa-chevron-left"></span></a>&nbsp&nbsp<strong>View Announcement</strong>
                              ...
                              <div class="box-tools">
                                  <div class="btn-group">
                                      ...
                                      <ul class="dropdown-menu">
                                          <li><a href="<?= base_url() ?>SuperAdmin/delete_post/<?= $post_id ?>">Delete Post</a></li>
                                          <li><a href="<?= base_url() ?>SuperAdmin/edit_post/<?= $post_id ?>">Edit Post</a></li>
                                      </ul>
                                  </div>
                              </div>
                              <!-- /.box-tools -->
