                          ...
                          <tbody>
                              ...
                              <?php foreach ($overloads as $overload) : ?>
                                  <tr>
                                      ...
                                      <td><a href="<?= base_url() ?>SuperAdmin/underload_view/<?= $overload->ou_stud_number ?>/<?= $overload->ou_term ?>/<?= $overload->ou_year ?>" class="btn btn-warning btn-sm"><span class="fa fa-eye"></span> View</a></td>
                                  </tr>
                              <?php endforeach; ?>
                          </tbody>
                      </table>
