 ...
 <aside class="main-sidebar">
   ...
   <section class="sidebar">
     ...
     <ul id="sidenav" class="sidebar-menu" data-widget="tree">
       ...
       <li class="<?= $this->uri->segment(2) == 'dashboard' ? ' active' : ''; ?>"><a href="<?= base_url() ?>Student/"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
       <li class="<?= $this->uri->segment(2) == 'announcements' ? ' active' : ''; ?>"><a href="<?= base_url() ?>Student/announcements"><i class="fa fa-bullhorn"></i><span>Announcements</span></a></li>
       ...
       <li class="treeview <?= in_array($this->uri->segment(2), array('profile', 'curriculum', 'course_card', 'cor', 'assessment')) ? ' active' : ''; ?>">
         <a href="#">
         ...
         <ul class="treeview-menu">
           <li><a style="color:<?= $this->uri->segment(2) == 'profile' ? 'white' : ''; ?>;" href="<?= base_url() ?>Student/profile/<?= $this->session->acc_number ?>"><i class="fa fa-file-text-o"></i> <span>Profile</span></a></li>
           <li><a style="color:<?= $this->uri->segment(2) == 'curriculum' ? 'white' : ''; ?>;" href="<?= base_url() ?>Student/curriculum"><i class="fa fa-list-alt"></i><span>Curriculum</span></a></li>
           <li><a style="color:<?= $this->uri->segment(2) == 'course_card' ? 'white' : ''; ?>;" href="<?= base_url() ?>Student/course_card"><i class="fa fa-file-text-o"></i> <span>Course Card</span></a></li>
           <li><a style="color:<?= $this->uri->segment(2) == 'cor' ? 'white' : ''; ?>;" href="<?= base_url() ?>Student/cor"><i class="fa fa-file-text-o"></i> <span>COR</span></a></li>
           <li><a style="color:<?= $this->uri->segment(2) == 'assessment' ? 'white' : ''; ?>;" href="<?= base_url() ?>Student/assessment/<?= $this->session->curr_term ?>/<?= $this->session->curr_year ?>"><i class="fa fa-file-text-o"></i> <span>Balance Inquiry</span></a></li>
         </ul>
       </li>
       ...
       <li class="treeview <?= in_array($this->uri->segment(2), array('parallel', 'offerings')) ? ' active' : ''; ?>">
         <a href="#">
         ...
         <ul class="treeview-menu">
           <li><a style="color:<?= $this->uri->segment(2) == 'parallel' ? 'white' : ''; ?>;" href="<?= base_url() ?>Student/parallel"><i class="fa fa-file-text-o"></i> <span>Parallel Courses</span></a></li>
           <li><a style="color:<?= $this->uri->segment(2) == 'offerings' ? 'white' : ''; ?>;" href="<?= base_url() ?>Student/offerings"><i class="fa fa-file-text-o"></i> <span>Course Offerings</span></a></li>
         </ul>
       </li>
